console.log("**********************")
console.log("00_bascitype ... arguments :")
console.log("**********************")
...
// name of that value in the enum.
...
// checking during compilation.You might expect Object to play a similar role, as it does in other languages.However, 
...
let lista1: any[] = [1, true, "free"];

lista1[1] = 100;

lista1.map(e => console.log(`${e} and tipo di ${typeof e}`))
...
// Null and Undefined #
console.log(">>>>>>>>>>> Null and Undefined () ... Union types>>>>>>>>>>")
...
// (the one exception being that undefined is also assignable to void).This helps avoid many common errors.
...
// For instance, never is the return type for a function expression or an arrow function expression that always throws 
// an exception or one that never returns; Variables also acquire the type never when narrowed by any type guards that can never be true.
...
declare function create_(o: object | null): void;

function create_2(o: object | null): void {
    // TODO
}
...
// Type assertions #
// Sometimes you’ll end up in a situation where you’ll know more about a value than 
// TypeScript does.Usually this will happen when you know the type of some entity could be more specific than its current type.
...
console.log("angle - bracket")
let someValue_: any = "this is a string";
let strLength_: number = (<string>someValue_).length;

// And the other is the as- syntax:
console.log("as- syntax")
let someValue__: any = "this is a string";
let strLength__: number = (someValue__ as string).length;
